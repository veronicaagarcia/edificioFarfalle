...
export function PrimeroA() {
	...
	const media: Media[] = [
		...
		{
			type: 'image',
			url: '/edificioFarfalle/images/1A/1.jpg', 
		},
	...
	return (
		<div className='w-full h-screen pt-12 overflow-y-scroll scrollbar-hide'>
			...
			<div
				className='w-full h-fit flex flex-col md:flex-row md:justify-around md:items-center mb-2 py-4 md:py-8 xl:py-12 bg-gradient-to-tr to-slate-950/80 via-nav/80 from-orange/80'
			>
