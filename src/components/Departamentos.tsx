...
import { LazyImage } from "./comon/LazyImage"
    ...
    <section className="pt-12 h-full w-full m-auto bg-background">
      <div className="container mx-auto mb-12 md:mb-20 px-3 md:px-20 lg:px-28">
        ...
        <div className="bg-white/50 rounded-lg shadow-sm mb-12">
          <p className="text-justify text-black text-opacity-90 mb-4 px-4 md:px-0 xl:px-8 pt-2 md:pt-3 text-base md:text-lg">
          ...
          <p className="text-justify text-black text-opacity-90 px-4 md:px-0 xl:px-8 pt-2 md:pt-3 text-base md:text-lg">
        ...
        <h3
          ...
          data-aos-duration="1000"
          data-aos-offset="200"
          className="text-lg md:mt-4 font-medium text-black text-center px-8 mb-8"
        >
