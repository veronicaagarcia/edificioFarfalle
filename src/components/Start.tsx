		...
		<main className='h-full flex flex-col'>
			...
			>
				...
				<div className='text-orange flex justify-center mt-2'>
					<button
						onClick={getStart}
						className='group relative inline-flex mb-2 h-10 items-center justify-center overflow-hidden rounded-md bg-orange md:bg-black px-4 font-medium text-neutral-200 transition hover:bg-orange hover:scale-110'
					>
