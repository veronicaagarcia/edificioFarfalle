...
//         : "text-slate-950/85 hover:scale-105 hover:drop-shadow-lg hover:font-semibold text-base hover:text-background",
...
//           loading="lazy"
//         />
//         <h1 className={`font-great-vibes text-orange -mt-16 pb-2 ${isMobile ? `ml-4 text-2xl` : `text-3xl`}`}>
//           Edificio Farfalle
//         </h1>
//       </div>
...
//         {!isMobile && (
//           <>
//             <NavLinks className={navLinksClass} activeClassName="text-background" exact to="/">
//               Inicio
//             </NavLinks>
//             <span className="text-slate-950/85 text-base" aria-hidden="true">
//               |
//             </span>
//             <NavLinks className={navLinksClass} activeClassName="text-background" exact to="/Departamentos">
//               Departamentos
//             </NavLinks>
//             <span className="text-slate-950/85 text-base" aria-hidden="true">
//               |
//             </span>
//             <NavLinks className={navLinksClass} activeClassName="text-background" exact to="/Servicios">
//               Servicios
//             </NavLinks>
//             <span className="text-slate-950/85 text-base" aria-hidden="true">
//               |
//             </span>
//             <NavLinks className={navLinksClass} activeClassName="text-background" exact to="/Contacto">
//               Contacto
//             </NavLinks>
//             <span className="text-slate-950/85 text-base" aria-hidden="true">
//               |
//             </span>
//             <NavLinks className={navLinksClass} activeClassName="text-background" exact to="/Reservas">
//               Reservas
//             </NavLinks>
//           </>
//         )}
...
export function Navbar({ sectionTopRef, isMobile }: NavbarProps) {
  ...
  // ✅ SOLUCIÓN: Usar la funcionalidad nativa de NavLink
  const NavLinks = useCallback(
    ({ to, exact, activeClassName, className, children, onClick }: NavLinksProps) => {
      const handleClick = () => {
        setOpenCloseMenu(false)
