...
export function PbA() {
	...
	return (
		<div className='w-full h-screen pt-12 overflow-y-scroll scrollbar-hide'>
			...
			<div
				className='w-full h-fit flex flex-col md:flex-row md:justify-around md:items-center mb-2 py-4 md:py-8 xl:py-12 bg-gradient-to-br to-slate-950/80 via-nav/80 from-orange/80'
			>
				<section className='w-full md:w-1/2 lg:w-1/3 h-fit flex flex-col px-5 pt-2'>
					<ul className='list-disc list-inside text-sm md:text-base xl:text-lg py-4 md:py-10 px-6 text-black opacity-90'>
						...
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Patio interno
						</li>
						<li className='flex items-center'>
						...
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Calefón
						</li>
						<li className='flex items-center'>
