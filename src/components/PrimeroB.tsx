...
export function PrimeroB() {
	...
	const media: Media[] = [
		...
		{
			type: 'image',
			url: '/edificioFarfalle/images/1B/1.jpg', 
		},
		{
			type: 'image',
			url: '/edificioFarfalle/images/1B/2.jpg', 
		},
	...
	return (
		<div className='w-full h-screen pt-12 overflow-y-scroll scrollbar-hide'>
			...
			<div
				className='w-full h-fit flex flex-col md:flex-row md:justify-around md:items-center mb-2 py-4 md:py-8 xl:py-12 bg-gradient-to-tl to-slate-950/80 via-nav/80 from-orange/80'
			>
				<section className='w-full md:w-1/2 lg:w-1/3 h-fit flex flex-col px-5 pt-2'>
					<ul className='list-disc list-inside text-sm md:text-base xl:text-lg py-4 md:py-10 px-6 text-black opacity-90'>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Cama matrimonial
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Sofá cama con carrión
							para 2 personas
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Placard
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>Baño privado
							(Ducha, bidet, papel higiénico, jabón)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Tender
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Mesa y sillas (para 4
							personas)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>Aire Acondicionado
							(frío/calor) en habitación y comedor
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Heladera
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Horno/hornallas
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>Electrodomésticos
							(pava eléctrica, tostadora y microondas)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>Utensilios de
							cocina (cubiertos, platos, vasos, ollas)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>
							Elementos de limpieza (Detergente, esponja, virulana, ballerina,
							trapo de piso, balde)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Termotanque
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Cesto de basura (Cocina
							y baño)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2 mb-4 md:mb-0'>•</span>Blanquería
							(toalla/toallón por persona y ropa de cama)
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Wifi gratuito
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>TV por cable
						</li>
						<li className='flex items-center'>
							<span className='text-white mr-2'>•</span>Té y café de cortesía
						</li>
					</ul>
				</section>
