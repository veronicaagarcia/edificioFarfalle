  ...
  return (
    <div className="w-full min-h-screen pt-12 overflow-y-auto">
      <div className="py-8 md:py-12 xl:py-16 2xl:py-20">
        <h2 className="text-lg md:text-xl font-mono font-medium uppercase text-orange/80 text-center">Primero B</h2>
        <h3 className="text-base text-center md:text-lg font-bold text-black opacity-80">80m²</h3>
      </div>
