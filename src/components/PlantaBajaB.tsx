...
export function PbB() {
	...
	return (
		<div className='w-full h-screen pt-12 overflow-y-scroll scrollbar-hide'>
			...
			<div
				className='w-full h-fit flex flex-col md:flex-row md:justify-around md:items-center mb-2 py-4 md:py-8 xl:py-12 bg-gradient-to-tl to-orange/80 via-nav/80 from-slate-950/80'
			>
